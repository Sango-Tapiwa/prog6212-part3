    ...
    public partial class InitialDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "lecturer@university.edu", "John", "Smith", "lecturer123", 0 },
                    { 2, "coordinator@university.edu", "Jane", "Doe", "coordinator123", 1 },
                    { 3, "manager@university.edu", "Bob", "Johnson", "manager123", 2 }
                });
